...
// 첫번째 language box
var additionalImage1 = document.querySelector(".additional1");
var languageInput1 = document.querySelector(".language1");
additionalImage1.addEventListener("click", function () {
  handleImageClick(additionalImage1, languageInput1);
});

languageInput1.addEventListener("blur", function () {
  var code = languageInput1.value.trim();
  if (code === "") {
    resetImageAndText(additionalImage1, languageInput1);
  }
});

// 두번째 language box
var additionalImage2 = document.querySelector(".additional2");
var languageInput2 = document.querySelector(".language2");
additionalImage2.addEventListener("click", function () {
  handleImageClick(additionalImage2, languageInput2);
});

languageInput2.addEventListener("blur", function () {
  var code = languageInput2.value.trim();
  if (code === "") {
    resetImageAndText(additionalImage2, languageInput2);
  }
});

// 세번째 language box
var additionalImage3 = document.querySelector(".additional3");
var languageInput3 = document.querySelector(".language3");
additionalImage3.addEventListener("click", function () {
  handleImageClick(additionalImage3, languageInput3);
});

languageInput3.addEventListener("blur", function () {
  var code = languageInput3.value.trim();
  if (code === "") {
    resetImageAndText(additionalImage3, languageInput3);
  }
});
